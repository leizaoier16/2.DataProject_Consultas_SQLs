...
Este proyecto consiste en el análisis de una base de datos de un videoclub, incluyendo películas, actores, clientes, alquileres y categorías. El objetivo fue desarrollar habilidades en SQL avanzado y aplicar buenas prácticas para la gestión y análisis eficiente de la información.
...
Se trabajó con tablas que representan películas, actores, clientes, trabajadores, tiendas, inventario y alquileres, incluyendo relaciones muchos a muchos donde fue necesario. Estas estructuras permitieron realizar análisis completos y reportes sobre el sistema del videoclub.
